...
describe("accelTimeoutFactor", () => {
	test("kvm same-arch = 1.0", () => expect(accelTimeoutFactor("kvm", false)).toBe(1.0));
	test("hvf same-arch = 1.0", () => expect(accelTimeoutFactor("hvf", false)).toBe(1.0));
	...
	test("kvm cross-arch = 1.0", () => expect(accelTimeoutFactor("kvm", true)).toBe(1.0));
	test("hvf cross-arch = 1.0", () => expect(accelTimeoutFactor("hvf", true)).toBe(1.0));
