...
_quickchr() {
    ...
    local commands="add start stop list ls status inspect env remove rm clean console exec qga license disk snapshot snap networks net doctor setup completions version help"
        ...
        args)
            ...
            case ${D}cmd in
                ...
                completions)
                    ...
                    ;;
                help)
                    local commands=(add start stop list status inspect env remove clean console exec qga license disk snapshot networks doctor setup completions version)
                    _describe 'command' commands
                    ;;
            esac
            ;;
...
set -l quickchr_commands add start stop list ls status inspect env remove rm clean console exec qga license disk snapshot snap networks net doctor setup completions version help
